...
import pandas as pd
from UID340to500Mapping import MapUID340to500, Create340to500UIDMapping
from CrfXMLFunctions import ConvertFloat
import glob
...
parser.add_option("-f","--diff_file",dest="f6",help="Output file: 1) too large differences, 2) change in Notation keys and methods, 3) missing UID")
