#!/bin/bash
#run-eu529-ghg-master.sh: EU529 inventory xml import in one step. 
...
ghg-master.py -c "EU529/KP*.csv" -p PartyProfile/PartyProfile_FIN_2022_3.xml\
	      -x PartyProfile/PartyProfile_FIN_2022_3_result.xml\
