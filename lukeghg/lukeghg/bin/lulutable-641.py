...
parser.add_option("-o","--output",dest="f3",help="Output file")
...
writer=pd.ExcelWriter(options.f3,engine='xlsxwriter')
...
df_datafrom.to_excel(writer,'LUTable6-4.1',startrow=34,startcol=0,header=False,index=False)
