...
setup(name='lukeghg',
      ...
      scripts=glob.glob('lukeghg/bin/[A-Za-z]*.py')+glob.glob('lukeghg/bin/[A-Za-z]*.sh')+glob.glob('lukeghg/bin/[A-Za-z]*.slurm')+['lukeghg/check/checkinventoryvalues.py','lukeghg/utility/convertutf8.py']
      )
