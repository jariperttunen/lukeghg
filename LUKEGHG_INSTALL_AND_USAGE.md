...
Both simply call `run-ghg-master.sh`and `run-eu529-ghg-master.sh` respectively. Therefore edits in these two files is 
reflected in the corresponding Slurm scripts. The usage is:
