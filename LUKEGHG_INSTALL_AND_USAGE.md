...
Inventory year is 2019  and output file LULUTable_6.4-1.xlsx. **Note** the summary rows may deviate from the sums of 
respective columns (in the order of 1000ha). This is due to rounding.
