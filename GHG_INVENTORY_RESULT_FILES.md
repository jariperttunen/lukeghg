...
time series which is the last item in the line.
...
For the time series rows the number sign (#) character denotes not only the beginning but also 
the end of the comment. The UID's (e.g. 810E194F-0D38-4486-8A88-96ACF87C205) are generated by CRFReporter.
